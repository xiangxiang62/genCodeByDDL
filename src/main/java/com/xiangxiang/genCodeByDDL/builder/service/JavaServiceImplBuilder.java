...
import main.java.com.xiangxiang.genCodeByDDL.model.dto.JavaServiceImplGenerateDTO;
 ...
 */
@Slf4j
public class JavaServiceImplBuilder {
    ...
    static {
        try {
            ...
            configuration.setClassLoaderForTemplateLoading(
                    JavaServiceImplBuilder.class.getClassLoader(), "templates"
            );
            ...
            // 打印模板文件路径，检查是否可以找到模板
            if (JavaServiceImplBuilder.class.getClassLoader().getResource("templates/TemplateServiceImpl.java.ftl") != null) {
                System.out.println("文件存在 TemplateServiceImpl.java.ftl");
            } else {
    ...
    public void setConfiguration(Configuration configuration) {
        JavaServiceImplBuilder.configuration = configuration;
    }
...
//            });
            ...
            Template temp = configuration.getTemplate("TemplateServiceImpl.java.ftl");
