...
import main.java.com.xiangxiang.genCodeByDDL.model.dto.JavaEntityVOGenerateDTO;
import main.java.com.xiangxiang.genCodeByDDL.model.dto.JavaQueryEntityGenerateDTO;
...
public class JavaEntityVOBuilder {
     ...
     * @return 生成的 java 代码
     */
    public static List<String> buildJavaEntityVOCode(List<TableSchema> tableSchemas) {
